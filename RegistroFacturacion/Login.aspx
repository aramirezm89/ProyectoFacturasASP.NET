<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="RegistroFacturacion.Login" %>
                    ...
                    <form class="col-12" id="form1" runat="server">
                        <div class="container text-center">
                            <div class="form-group" style="margin-top: 15px">
                                ...
                                <asp:TextBox ID="txtUser" CssClass=" form-control-lg caja" placeholder="Ingrese nombre de usuario" runat="server"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lblPass" runat="server" CssClass="label-pass" Text="Contraseña:"></asp:Label>
                                <asp:TextBox ID="txtPass" TextMode="Password" CssClass="form-control-lg caja " placeholder="Ingrese su contraseña" runat="server"></asp:TextBox>
                            </div>
